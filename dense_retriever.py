...
def main(cfg: DictConfig):
    ...
    if index_path and index.index_exists(index_path):
        ...
        ) # 这里 添加的self.index_id_to_db_id（self.index.search_knn中）中的元素
        if index_path:
            retriever.index.serialize(index_path)

    # get top k results
    top_ids_and_scores = retriever.get_top_docs(questions_tensor.numpy(), cfg.n_docs) # 所有问题对应的答案信息
...
python dense_retriever.py model_file=/home/duhuifang/git_local/DPR/downloads/mycheckpoints/dpr_biencoder.8 qa_dataset=nq_test encoded_ctx_files=[\"/home/duhuifang/git_local/DPR/downloads/mydata/ctx_embeddings_0_*\"] ctx_datatsets=[dpr_wiki] out_file=/home/duhuifang/git_local/DPR/downloads/evaluation

...
class JsonlTablesCtxSrc(object):
    ...
    def load_data_to(self, ctxs: Dict):
        ...
        """
        ['680789', 'In addition, for Top 20 players, their best two results at Premier 5 tournaments will also count. All WTA players also have a Universal Tennis Rating, based on head-to-head results. The points distribution for tournaments in 2017 is shown below. S = singles players, D = doubles teams, Q = qualification players. <nowiki>*</nowiki> Assumes undefeated Round Robin match record. "+H" indicates that Hospitality is provided. These lists are based on the WTA Rankings. The Global Advisory Council of ']
        """

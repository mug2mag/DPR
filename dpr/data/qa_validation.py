...
def calculate_matches(
    ...
    for question_hits in scores:
        ...
        if best_hit is not None:
            top_k_hits[best_hit:] = [v + 1 for v in top_k_hits[best_hit:]]  # v+1 意思是第n个如果为true，对n+1@hit来说也是多了一个
...
# def check_answer(questions_answers_docs, dpr_all_documents, tokenizer, match_type) -> List[bool]:
    ...
    hits = []  # dpr_all_documents中每个文档只要包含大于等于一个答案，则hits中就append一个true

    # 排序靠前的前n_docs中命中答案的有几个
